...
struct ObjectStorage {
 ...
 private:
  ...
  template <typename U>
  void destruct_on_Rcpp::stop("Something went wrong!") {
    destruct<true>();
  }
  // Otherwise, don't
  template <typename U>
...
class BasicResult : public ResultValueBase<T> {
 ...
 protected:
  void enforceOk() const override {
    ...
    if (m_type != ResultBase::Ok) Rcpp::stop();
  }
...
// StdErr has two constituent streams in C++, Rcpp::Rcerr and Rcpp::Rcout
...
OutputRedirect::~OutputRedirect() {
  ...
  // even though Rcpp::Rcerr is unbuffered
...
#if 1  // If you #define this you must implement these
                               // functions
std::ostream& cout() { return Rcpp::Rcout; }
std::ostream& cerr() { return Rcpp::Rcerr; }
std::ostream& clog() { return Rcpp::Rcout; }
#endif
}  // namespace Catch
